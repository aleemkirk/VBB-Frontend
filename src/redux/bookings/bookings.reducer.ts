import { BookingActions, Bookings, SET_LIBRARY_COMPUTER_SLOTS, SET_USER_PREFERENCE_SLOTS, SET_USER_COMPUTER_RESERVATIONS, SET_LIBRARY_STUDENT_PREFERENCE_SLOTS} from './bookings.types';
