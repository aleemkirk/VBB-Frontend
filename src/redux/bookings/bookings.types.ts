...
export const GET_LIBRARY_COMPUTER_SLOTS_SUCCESS = 'GET_LIBRARY_COMPUTER_SLOTS_SUCCESS';
export const GET_LIBRARY_COMPUTER_SLOTS_FAILED = 'GET_LIBRARY_COMPUTER_SLOTS_FAILED';
...
export const CREATE_USER_PREFERENCE_SLOT_SUCCESS = 'CREATE_USER_PREFERENCE_SLOT_SUCCESS';
export const CREATE_USER_PREFERENCE_SLOT_FAILED = 'CREATE_USER_PREFERENCE_SLOT_FAILED';
...
export const GET_USER_PREFERENCE_SLOTS_SUCCESS = 'GET_USER_PREFERENCE_SLOTS_SUCCESS';
export const GET_USER_PREFERENCE_SLOTS_SUCCESS_FAILED = 'GET_USER_PREFERENCE_SLOTS_SUCCESS_FAILED';

export const DELETE_USER_PREFERENCE_SLOT = 'DELETE_USER_PREFERENCE_SLOT';
export const DELETE_USER_PREFERENCE_SLOT_SUCCESS = 'DELETE_USER_PREFERENCE_SLOT_SUCCESS';
export const DELETE_USER_PREFERENCE_SLOT_FAILED = 'DELETE_USER_PREFERENCE_SLOT_FAILED';

export const SET_LIBRARY_STUDENT_PREFERENCE_SLOTS = 'SET_LIBRARY_STUDENT_PREFERENCE_SLOTS';
export const GET_LIBRARY_STUDENT_PREFERENCE_SLOTS = 'GET_LIBRARY_STUDENT_PREFERENCE_SLOTS';
export const GET_LIBRARY_STUDENT_PREFERENCE_SLOTS_SUCCESS = 'GET_LIBRARY_STUDENT_PREFERENCE_SLOTS_SUCCESS';
export const GET_LIBRARY_STUDENT_PREFERENCE_SLOTS_FAILED = 'GET_LIBRARY_STUDENT_PREFERENCE_SLOTS_FAILED';
...
export const UPDATE_USER_COMPUTER_RESERVATION = 'UPDATE_USER_COMPUTER_RESERVATION';
export const UPDATE_USER_COMPUTER_RESERVATION_SUCCESS = 'UPDATE_USER_COMPUTER_RESERVATION_SUCCESS';
export const UPDATE_USER_COMPUTER_RESERVATION_FAILED = 'UPDATE_USER_COMPUTER_RESERVATION_FAILED';

export const UPDATE_USER_COMPUTER_RESERVATION_ATTENDANCE = 'UPDATE_USER_COMPUTER_RESERVATION_ATTENDANCE';
export const UPDATE_USER_COMPUTER_RESERVATION_ATTENDANCE_SUCCESS = 'UPDATE_USER_COMPUTER_RESERVATION_ATTENDANCE_SUCCESS';
export const UPDATE_USER_COMPUTER_RESERVATION_ATTENDANCE_FAILED = 'UPDATE_USER_COMPUTER_RESERVATION_ATTENDANCE_FAILED';
