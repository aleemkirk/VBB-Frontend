...
import {
  createLibraryTimeSlot,
  updateLibraryTimeSlot,
  deleteLibraryTimeSlot,
  setLibraryTimeSlots,
  setActiveLibraryTimeSlot,
...
const LibraryProfile = () => {
  ...
  const [createLibraryHourSlotModalOpen, set_createLibraryHourSlotModalOpen] =
        ...
        {innerProps.event.groupId !== 'alreadyBooked' &&
          rescheduleActive === true && (
            ...
            >
              <button
                type="button"
                onClick={(e) => handleLibSlotRemove(innerProps.event)}
                style={{ padding: 1 }}
                id="btnDeleteEvent"
              >
                X
  ...
  return (
    <>
      <BasicModal
        open={createLibraryHourSlotModalOpen}
        onClose={() => set_createLibraryHourSlotModalOpen(false)}
        title={'Create Library Time Slot'}
      >
        <Box
          display={'flex'}
          flexWrap={'wrap'}
        ...
        >
          ...
          >
            Are you sure you want to create this open slot? These are designated
            open hours for students and mentors
          </Typography>
          <Typography
            mt={1}
            mb={1}
          ...
          <Button
            onClick={() => handleCreateLibraryHourSlot(newBooking)}
            variant="contained"
            color="info"
            sx={{ mt: 2 }}
          >
      ...
      >
        ...
        >
          <Typography
            ...
            color={scss_variables.primary_color}
          >
            Are you sure you want to delete this open slot? No students or
            mentors will be able to book a session/reserve computers during this
            time.
          </Typography>
          <Typography
            mt={1}
          ...
          <Button
            onClick={() => handleDeleteLibraryHourSlot(activeBookingToDelete)}
            variant="contained"
            color="info"
            sx={{ mt: 2 }}
          >
          ...
          <Button
            onClick={() => handleCancelDeleteLibraryHourSlot()}
            variant="contained"
            color="error"
            sx={{ mt: 2 }}
          >
