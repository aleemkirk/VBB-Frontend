...
import { StudentOnboardingForm, MentorOnboardingForm } from '../../redux/registration/registration.types'
...
import { completeMentorOnboard, completeStudentOnboard } from '../../redux/registration/registration.actions';
...
const Onboarding = () => {
    ...
    const [onboardingSubmitOpen, set_onboardingSubmitOpen] = React.useState(false);
    ...
    return(
    <>
    <BasicModal open={onboardingSubmitOpen} onClose={()=>set_onboardingSubmitOpen(false)} title={'Completing Your Profile...'}>
      {appState.loading
        ? (
          <CircularProgress />
        )
        : (
          ...
          ? (
            ...
            <Button component={Link} to='/?onboard_complete=true' variant="contained" color="info" sx={{mt:2}}>
              Get Started
            </Button>
            </>
          )
          : (
            ...
            <Button onClick={()=>set_onboardingSubmitOpen(false)} variant="contained" color="info" sx={{mt:2}}>
              Re-enter Info
            </Button>
            </>
          )}
        ...
        <div className="card-container">
          ...
          <div className="card-body">
            <Box display="flex" alignItems="center">
              <Typography mt={1} mb={1} variant="body1" alignSelf="flex-start" color={scss_variables.primary_color}>
                To finish setting up your account, please follow this simple questionaire to customize your experience.
              </Typography>
            </Box>
            <Typography mt={1} mb={1} variant="h6" alignSelf="flex-start" color={scss_variables.primary_color}>
              Complete Your {user.isMentor === true ? 'Mentor' :'Student'} Profile
            </Typography>

            {user.isMentor === true ? <MentorOnboardForm handleSubmit={handleMentorOnboardSubmit}/>
            : <StudentOnboardForm handleSubmit={handleStudentOnboardSubmit}/>
            }
          </div>
        </div>
      </Grid>
